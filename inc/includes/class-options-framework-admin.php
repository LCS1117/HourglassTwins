...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( '主題設定', 'theme-textdomain' ),
			'menu_title' => __( '主題設定', 'theme-textdomain' ),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'orbital-probe-cannon',
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', '设置已保存。', 'updated fade' );
	}
