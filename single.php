...
<div id="primary">
    <main id="main">
        ...
        <?php } ?>
            <blockquote>
                <p style="word-break:break-all;"><b>本文採用 <a
                                href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh_TW"
                                target="_blank"
                                class="footer-develop-a">CC BY-NC-SA 4.0</a>
                        協議進行許可，在您遵循此協議的情況下，可以自由共享與編譯本文章。</b></p>
                <p style="word-break:break-all;"><b>本文連結：</b><a
                            href="<?php the_permalink(); ?>"><?php the_permalink(); ?></a></p>
            </blockquote>
            <?php if (comments_open()) { ?>
            <h2><i class="fa fa-comments"></i> 留言</h2>
